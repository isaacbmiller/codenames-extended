...
export function RoomClient({ initialRoom, browserSupabaseConfig }: RoomClientProps) {
  ...
  return (
    <main className="grain min-h-screen px-4 py-4 md:px-6 md:py-5 lg:py-9">
      <div className="mx-auto flex max-w-[1500px] flex-col gap-4">
        ...
        <section className="paper-panel relative px-3 py-3 md:px-4 md:py-4">
          ...
          <div className="relative">
            <div
              className={clsx(
                "grid grid-cols-5 gap-1.5 transition-opacity md:h-[calc(100dvh-17rem)] md:grid-rows-5 md:gap-3 lg:h-[calc(100dvh-14rem)]",
